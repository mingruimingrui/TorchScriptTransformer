...
class TransformerDecoderLayer(torch.nn.Module):
    ...
    def forward(
        ...
        # type: (Tensor, Tensor, Optional[Tensor], Optional[Tensor], Optional[Tensor], Optional[Tuple[Tuple[Tensor, Tensor], Tuple[Tensor, Tensor]]], Optional[bool]) -> Tuple[Tensor, Optional[Tensor], Tuple[Tuple[Tensor, Tensor], Tuple[Tensor, Tensor]]]
